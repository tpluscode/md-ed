...
$__System.register("1", ["5", "2", "3", "4"], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["src/bower-deps.ts","marked"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("src/bower-deps.ts"), require("marked"));
  else
    factory(MdEdDeps, marked);
});
